...
The dataset includes responses from students across different departments and academic years, containing ratings, satisfaction levels, and suggestions for improvement. Using Python libraries such as **Pandas, NumPy, Matplotlib, and Scikit-learn**, the data is cleaned, processed, and visualized.

A **Linear Regression model** is developed to predict student satisfaction based on teaching quality and lab ratings. Additionally, a **Power BI dashboard** is created to present insights in a visual and interactive manner, helping institutions improve academic quality and decision-making.
...
* Analyze trends using Exploratory Data Analysis (EDA)
...
* Google Forms & Google Sheets (Data Collection)
...
* Predictive model for satisfaction analysis
